...
В местной библиотеке хотят перейти на цифровой учет книг. В данном проекте реализованно веб-приложение. 
С помощью этого приложения библиотекари имеют возможность регистрировать читателей, выдавать им
